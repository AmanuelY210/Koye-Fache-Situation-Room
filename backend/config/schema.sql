...
INSERT INTO settings (id, logo, header_text, subtitle_text, footer_text, theme, background_color, text_color, card_color, header_color, counter_color, screen_background, countdown_enabled, countdown_title, countdown_target_date, phone1, phone2) VALUES (1, NULL, 'KOYE FACHE PROSPERITY PARTY', 'LIVE ELECTORS COUNT', 'Developed By Amanuel ICT Solution', 'light', '#ffffff', '#1a1a2e', '#f8f9fa', '#e94560', '#e94560', '#ffffff', 0, 'Days Left', DATE_ADD(NOW(), INTERVAL 30 DAY), '09-84-19-40-54', '09-40-96-77-77');
